...
if($_FILES['uploadfile']['error'] !=UPLOAD_ERR_OK){
	switch($_FILES['uploadfile']['error']){
		...
		die('Uploades file exceeds the upload_max_filesize directive'.'in php.ini.');
		break;
		case UPLOAD_ERR_FORM_SIZE :
		die('Uploades file exceeds the max. size of html form support');
		break;
		case UPLOAD_ERR_PARTIAL :
		 die('Uploaded file is partially uploaded');
		 break;
		 case UPLOAD_ERR_NO_FILE :
		 die('No file aws uploaded');
		 break;
		 case UPLOAD_ERR_NO_TMP_DIR :
		 die('The server is missing temprory folder');
		 break;
		 case UPLOAD_ERR_CANT_WRITE :
		 die('the server failed to erite the uploaded file to disk');
		 break;
...
break;
default:
die('The file you uploaded not supported format');
}
...
<html>
<head>
<title>Here is your Book pic</title>
</head>
<body>
...
<tr><td>Upload date:</td><td><?php echo $image2_date;?></td></tr>
</table>
<?php
...
if(empty($bname)){
echo 'Book name cannot left blank.';
header("Refresh: 2;URL:doit.php");
echo "</br>";
echo "If you are not redirected automatically";
echo "<a href='doit.php'>Click Here</a>";
}	
if(empty($category)){
echo 'Book Category cannot left blank.';
header("Refresh: 2;URL:doit.php");
echo "</br>";
echo "If you are not redirected automatically";
echo "<a href='doit.php'>Click Here</a>";
...
if(empty($bprice)){
echo 'Book Price cannot left blank.';
header("Refresh: 2;URL:doit.php");
echo "</br>";
echo "If you are not redirected automatically";
echo "<a href='doit.php'>Click Here</a>";
...
if(empty($des)){
echo 'Book Description cannot left blank.';
header("Refresh: 2;URL:doit.php");
echo "</br>";
echo "If you are not redirected automatically";
echo "<a href='doit.php'>Click Here</a>";
...
$result = mysql_query($query, $db) or die(mysql_error($db));
echo "<h3>";
echo "Book Data Successfully inserted";
echo "</h3>";
header('Refresh: 2;URL=proceed2.php');
echo '<p>You will be redirected to address page.</p>';
echo '<p>If your browser doesn\'t redirect you properly automatically,'.
'<a href="proceed2.php">CLICK HERE</a>.</p>';
}
}
}
?>
<h3></h3>
<h3>To give your address<a href="proceed2.php">Click Here.</a></h3>
</body>
</html>
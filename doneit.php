<?php
$db=mysql_connect('localhost','root','ankur@1') or die('Unable to connect.Check your conne3ction parameters');
...
if(empty($username)){
echo 'User ID cannot left blank.';
header("Refresh: 2;URL:registration.php");
echo "</br>";
echo "If you are not redirected automatically";
echo "<a href='registration.php'>Click Here</a>";
}
if(empty($password)){
echo 'Password cannot left blank.';
header("Refresh: 2;URL:registration.php");
echo "</br>";
echo "If you are not redirected automatically";
echo "<a href='registration.php'>Click Here</a>";
...
if(empty($cpass)){
echo 'Confirm Password cannot left blank.';
header("Refresh: 2;URL:registration.php");
echo "</br>";
echo "If you are not redirected automatically";
echo "<a href='registration.php'>Click Here</a>";
...
if(empty($mobi)){
echo 'Mobile Number cannot left blank.';
header("Refresh: 2;URL:registration.php");
echo "</br>";
echo "If you are not redirected automatically";
echo "<a href='registration.php'>Click Here</a>";
...
if(empty($email)){
echo 'EMail ID cannot left blank.';
header("Refresh: 2;URL:registration.php");
echo "</br>";
echo "If you are not redirected automatically";
echo "<a href='registration.php'>Click Here</a>";

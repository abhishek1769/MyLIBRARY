...
<form name="form3" method="post" action="action.php?action=submit" >
<table>
...
<tr><td>Select Your State:</td><td><select name="state">
...
<form name="continueform" action="action2.php?action=submit" method="post" >
<h3>Continue with saved address</h3>

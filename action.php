...
if (isset($_POST['submit'])){
	...
	if(empty($desa)){
echo 'User Adress cannot left blank.';
header("Refresh: 2;URL:proceed2.php");
echo "</br>";
echo "If you are not redirected automatically";
echo "<a href='proceed2.php'>Click Here</a>";
}
if(empty($ucity)){
echo 'User city cannot left blank.';
header("Refresh: 2;URL:proceed2.php");
echo "</br>";
echo "If you are not redirected automatically";
echo "<a href='proceed2.php'>Click Here</a>";
...
if(empty($ucitypin)){
echo 'User city PIN cannot left blank.';
header("Refresh: 2;URL:proceed2.php");
echo "</br>";
echo "If you are not redirected automatically";
echo "<a href='proceed2.php'>Click Here</a>";
...
if(empty($state)){
echo 'User State cannot left blank.';
header("Refresh: 2;URL:proceed2.php");
echo "</br>";
echo "If you are not redirected automatically";
echo "<a href='proceed2.php'>Click Here</a>";
